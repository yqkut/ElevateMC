...
public final class PostMatchInvLang {
    ...
    private static TextComponent clickToViewLine(UUID member) {
        ...
        component.setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new ComponentBuilder(ChatColor.GREEN + "Click to view inventory of " + ChatColor.LIGHT_PURPLE + memberName).create()));
