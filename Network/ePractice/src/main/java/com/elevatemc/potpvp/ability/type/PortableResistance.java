...
public class PortableResistance extends Ability {
    public static ItemStack itemStack;

    public PortableResistance() {
    ...
    public String getDisplayName() {
        return ChatColor.GOLD.toString() + ChatColor.BOLD + "Resistance";
    }
    ...
    public List<String> getLore() {
        ...
        toReturn.add(ChatColor.GRAY + "around you Resistance 3 for 5 seconds");
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        player.addPotionEffect(new PotionEffect(PotionEffectType.DAMAGE_RESISTANCE, 6*20, 2), true);
