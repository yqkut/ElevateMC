...
//https://github.com/joeleoli/BukkitReflection/blob/master/BukkitReflection.java
...
public class ReflectionUtil {
    ...
    public static List<Class<?>> toParamTypes(Object... params) {
        return null;
    }

    public static Method getDeclaredMethod(Class<?> clazz, String methodName, Class<?>... params) {
        try {
            final Method declaredMethod = clazz.getDeclaredMethod(methodName, params);
    ...
    public static void callMethod(Object instance, String methodName, Object... params) {
        try {
//            final Method method = instance.getClass().getMethod(methodName, toParamTypes(params));
        } catch(Exception ex) {
            ex.printStackTrace();
        }
    }
