...
public enum MatchState {
     ...
     * @see com.elevatemc.potpvp.match.event.MatchCountdownStartEvent
     */
    COUNTDOWN,
     ...
     * @see com.elevatemc.potpvp.match.event.MatchEndEvent
     */
    ENDING,
     ...
     * @see com.elevatemc.potpvp.match.event.MatchTerminateEvent
     */
    TERMINATED
