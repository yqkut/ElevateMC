...
import com.elevatemc.potpvp.postmatchinv.listener.PostMatchInvGeneralListener;
...
public final class PostMatchInvHandler {
    ...
    private void messagePlayers(Match match) {
        ...
        invMessages.forEach((uuid, lines) -> {
            ...
            player.sendMessage(org.bukkit.ChatColor.DARK_AQUA + "Post-Match Inventories " + ChatColor.GRAY + "(click name to view)");
