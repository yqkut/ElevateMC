...
final class SpectateButton extends Button {
    ...
    public List<String> getDescription(Player player) {
        ...
        if (match.isRanked()) {
            description.add(ChatColor.GREEN + "Competitive");
        } else {
            description.add(ChatColor.GRAY + "Casual");
        }

        description.add("");
        description.add(ChatColor.DARK_AQUA + "Gamemode: " + ChatColor.WHITE + match.getGameMode().getName());
        ...
        description.add("");
        description.add(ChatColor.GREEN + "(Left Click to Spectate)");
    ...
    public byte getDamageValue(Player player) {
        return match.getGameMode().getIcon().getData();
    }
