package com.elevatemc.potpvp.party.menu;
        ...
        for (UUID uuid : party.getMembers()) {
            ...
            toReturn.put(toReturn.isEmpty() ? 0 : toReturn.size(), new Button() {
                ...
                public String getName(Player player) {
                    return PatchedPlayerUtils.getFormattedName(member.getUniqueId());
                }
                ...
                public void clicked(Player player, int slot, ClickType clickType) {
                    if (party.isLeader(player.getUniqueId())) {
                        ...
                        party.message(ChatColor.YELLOW + member.getDisplayName() + "'s kit has been set to " + ChatColor.GOLD + next.getName());
